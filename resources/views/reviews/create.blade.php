                                ...
                                <div class="form-group row">
                                    <label for="faculty" class="col-md-4 col-form-label text-md-right">学部・学科名</label>
                                        <div class="col-md-6">
                                            ...
                                            <p class="title__error" style="color:red">{{ $errors->first('review.faculty_id') }}</p>
                                        </div> 
                                </div>
                                <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            @foreach($evaluations as $evaluation)
                                                <input type="radio" name="review[evaluation_id]" value="{{ $evaluation->id }}"/>
                                                    {{ $evaluation->name }}
                                            @endforeach
                                            <p class="body__error" style="color:red">{{ $errors->first('review.evaluation_id') }}</p>
                                        </div>
                                </div>
                                <div class="form-group row">
                                    <label for="get_credit" class="col-md-4 col-form-label text-md-right">単位取得度</label>
                                        <div class="col-md-6">
                                            ...
                                            <p class="body__error" style="color:red">{{ $errors->first('review.get_credit') }}</p>
                                        </div>
                                </div>
                                <div class="form-group row">
                                    <label for="adequacy" class="col-md-4 col-form-label text-md-right">充実度</label>
                                        <div class="col-md-6">
                                            ...
                                            <p class="body__error" style="color:red">{{ $errors->first('review.adequacy') }}</p>
                                        </div>
                                </div>
                                <div class="form-group row">
